...
/**
  ...
  + getDollar Amount(quarters : int, dimes : int, nickels : int) : double
  + toString() : String
 */
...
public class Coins
{
    ...
    /*
     * Initializes a new instance of the Coins class. Sets the number of coins for each coin type to zero.
     */
    public Coins()
    {
        this(0,0,0);
     ...
     * 
     * @return dollarAomunt The dollar value of coins basde on the coinType
     *         sepecified.
     */
